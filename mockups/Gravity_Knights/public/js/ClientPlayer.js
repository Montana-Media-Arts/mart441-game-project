<<<<<<< HEAD:mockups/Beta_Zero_Test/public/js/ClientPlayer.js
/* jshint esversion: 6 */
...
class ClientPlayer {
	...
	move() {
		...
		if (keyIsDown(68) && this.pos.x <= 800 - 50) {
			this.pos.x += 5;
			if (keyIsDown(32) && this.attackpos.x == this.pos.x + 15.5) {
				this.attackpos.x = this.pos.x + 60 - this.attackvel;
				this.attackvel -= this.attackacc;
			} else {
				this.attackpos.x = this.pos.x + 15.5;
			}
...
>>>>>>> 1bd2eca1b2b9e481761ed6a17f977dd5adce249b:mockups/Gravity_Knights/public/js/ClientPlayer.js
